...
PHILIPPINE_ENDANGERED_SPECIES = {
    ...
    "white lauan": {
        ...
        "iucn_color": "#fbc02d",
        "protected": True,
        "description": "Philippine dipterocarp timber species referenced in DENR/IUCN conservation lists.",
        "cutting_allowed": False,
    },
    "bagtikan": {
        "scientific_name": "Parashorea malaanonan",
        "status": "Critically Endangered",
        "status_code": "CR",
        "iucn_color": "#d32f2f",
        "protected": True,
        "description": "Large dipterocarp tree threatened by forest loss and historical timber extraction.",
        "cutting_allowed": False,
    },
    "mayapis": {
        "scientific_name": "Shorea squamata",
        "status": "Endangered",
        "status_code": "EN",
        "iucn_color": "#f57c00",
        "protected": True,
        "description": "Native dipterocarp species included for stronger Philippine conservation screening.",
        "cutting_allowed": False,
    },
    "palosapis": {
        "scientific_name": "Anisoptera thurifera",
        "status": "Vulnerable",
        "status_code": "VU",
        "iucn_color": "#fbc02d",
        "protected": True,
        "description": "Lowland forest tree monitored in Philippine biodiversity and timber references.",
        "cutting_allowed": False,
    },
    # Least Concern
    "mahogany": {
